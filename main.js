...
const btnSortAge = document.getElementById("btnSortAge");
...
btnInsertUpdate.addEventListener("click", () => {
    ...
    if (btnInsertUpdate.value == "insert") {
        ...
        arrRecords[parseInt(btnInsertUpdate.value)].age =
...
btnSortName.addEventListener("click", () => {
    ...
    arrRecords.sort((a, b) => {
        ...
        return a.fname
            .toLowerCase()
            .localeCompare(b.fname.toLowerCase());
...
btnSaveFile.addEventListener("click", () => {
    ...
    const data = JSON.stringify(arrRecords, null, 2);
